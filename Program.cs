...
//Cria o administrador com validações.
...
//retorna todos os veiculos da lista
...
app.MapPut("/veiculos/update/{id}", ([FromRoute] int id, VeiculoDTO veiculoDTO, IVeiculoServico veiculoServico) =>
{   
...
//Apaga o veiculo buscando pelo id.
app.MapDelete("/veiculos/delete/{id}", ([FromRoute] int id , IVeiculoServico veiculoServico) =>
{
    var veiculo = veiculoServico.BuscaPorId(id);
